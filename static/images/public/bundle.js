var app = (function () {
    ...
    function create_if_block_7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option, file$1, 47, 20, 1714);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(47:16) {#if canConvertToPNG}",
    		ctx
    	});
    ...
    function create_if_block_6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			option.__value = "jpg";
    			option.value = option.__value;
    			add_location(option, file$1, 50, 20, 1831);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, option, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(50:16) {#if canConvertToJPEG}",
    		ctx
    	});
    ...
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			option.__value = "webp";
    			option.value = option.__value;
    			add_location(option, file$1, 53, 20, 1949);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, option, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(53:16) {#if canConvertToWebP}",
    		ctx
    	});
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			option.__value = "svg";
    			option.value = option.__value;
    			add_location(option, file$1, 56, 20, 2067);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, option, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(56:16) {#if canConvertToSVG}",
    		ctx
    	});
    ...
    // (62:8) {#if !data.options.compress.lossless}
    function create_if_block_3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(62:8) {#if !data.options.compress.lossless}",
    		ctx
    	});
    ...
    // (98:8) {#if !data.options.compress.lossless}
    function create_if_block_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(98:8) {#if !data.options.compress.lossless}",
    		ctx
    	});
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = space();
    			input1 = element("input");
    			add_location(p0, file$1, 127, 16, 4973);
    			attr_dev(input0, "type", "number");
    			attr_dev(input0, "min", "1");
    			attr_dev(input0, "step", "1");
    			add_location(input0, file$1, 128, 16, 5003);
    			attr_dev(div0, "class", "widget anyFormat svelte-qcmiaf");
    			add_location(div0, file$1, 126, 12, 4925);
    			add_location(p1, file$1, 131, 16, 5161);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "min", "1");
    			attr_dev(input1, "step", "1");
    			add_location(input1, file$1, 132, 16, 5192);
    			attr_dev(div1, "class", "widget anyFormat svelte-qcmiaf");
    			add_location(div1, file$1, 130, 12, 5113);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div0, anchor);
    			append_dev(div0, p0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(126:8) {#if inputFormat === \\\"svg\\\"}",
    		ctx
    	});
    ...
    // (144:8) {#if data.options.compress.inline}
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			input = element("input");
    			add_location(p, file$1, 145, 16, 5650);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "class", "svelte-qcmiaf");
    			add_location(input, file$1, 146, 16, 5687);
    			attr_dev(div, "class", "widget anyFormat svelte-qcmiaf");
    			add_location(div, file$1, 144, 12, 5602);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(144:8) {#if data.options.compress.inline}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	let if_block4 = !/*data*/ ctx[0].options.compress.lossless && create_if_block_3(ctx);
    	let if_block5 = !/*data*/ ctx[0].options.compress.lossless && create_if_block_2(ctx);
    	let if_block6 = /*inputFormat*/ ctx[2] === "svg" && create_if_block_1$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div5, file$1, 90, 8, 3334);
    			attr_dev(input4, "type", "checkbox");
    			attr_dev(input4, "class", "svelte-qcmiaf");
    			add_location(input4, file$1, 138, 16, 5411);
    			add_location(label4, file$1, 137, 12, 5386);
    			attr_dev(div6, "class", "widget anyFormat svelte-qcmiaf");
    			set_style(div6, "padding-top", "14px");
    			add_location(div6, file$1, 136, 8, 5316);
    			attr_dev(div7, "class", "row");
    			add_location(div7, file$1, 36, 4, 1291);
    			attr_dev(main, "class", "svelte-qcmiaf");
    			add_location(main, file$1, 35, 0, 1279);
    		},
