var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(legend0, file$4, 13, 3, 231);
    			add_location(fieldset0, file$4, 12, 2, 216);
    			attr_dev(div0, "class", "section svelte-10z5nmq");
    			add_location(div0, file$4, 11, 1, 191);
    			add_location(legend1, file$4, 19, 3, 338);
    			attr_dev(input0, "type", "button");
    			input0.value = "🖼️ Images";
    			attr_dev(input0, "title", "Image Optimizer");
    			add_location(input0, file$4, 20, 3, 365);
    			attr_dev(input1, "type", "button");
    			input1.value = "🗛 Fonts";
    			attr_dev(input1, "title", "Web Font Generator");
    			add_location(input1, file$4, 21, 3, 471);
    			add_location(fieldset1, file$4, 18, 2, 323);
    			attr_dev(div1, "class", "section svelte-10z5nmq");
    			add_location(div1, file$4, 17, 1, 298);
    			attr_dev(main, "class", "svelte-10z5nmq");
    			add_location(main, file$4, 10, 0, 182);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(input0, "click", /*click_handler*/ ctx[0], false, false, false),
    					listen_dev(input1, "click", /*click_handler_1*/ ctx[1], false, false, false)
    				];
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ createEventDispatcher, dispatch, openURL });
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 116, 3, 3147);
    			attr_dev(div1, "id", "control");
    			attr_dev(div1, "class", "svelte-2vyb1p");
    			add_location(div1, file, 114, 2, 3090);
    			...
    			add_location(iframe, file, 131, 5, 3542);
    			attr_dev(div2, "id", "banner_container");
    			attr_dev(div2, "class", "svelte-2vyb1p");
    			add_location(div2, file, 130, 4, 3480);
    			attr_dev(div3, "id", "resize_area");
    			attr_dev(div3, "class", "svelte-2vyb1p");
    			add_location(div3, file, 129, 3, 3452);
    			add_location(p0, file, 137, 6, 3760);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "size", "45");
    			set_style(input0, "width", "200px");
    			add_location(input0, file, 138, 6, 3785);
    			attr_dev(input1, "type", "button");
    			input1.value = "↻";
    			attr_dev(input1, "class", "svelte-2vyb1p");
    			add_location(input1, file, 139, 6, 3899);
    			attr_dev(div4, "class", "widget");
    			add_location(div4, file, 136, 5, 3732);
    			add_location(p1, file, 142, 6, 4001);
    			attr_dev(input2, "type", "number");
    			attr_dev(input2, "size", "45");
    			attr_dev(input2, "min", "0");
    			attr_dev(input2, "class", "svelte-2vyb1p");
    			add_location(input2, file, 143, 6, 4021);
    			attr_dev(div5, "class", "widget");
    			add_location(div5, file, 141, 5, 3973);
    			add_location(p2, file, 146, 6, 4163);
    			attr_dev(input3, "type", "number");
    			attr_dev(input3, "size", "45");
    			attr_dev(input3, "min", "0");
    			attr_dev(input3, "class", "svelte-2vyb1p");
    			add_location(input3, file, 147, 6, 4184);
    			attr_dev(div6, "class", "widget");
    			add_location(div6, file, 145, 5, 4135);
    			add_location(p3, file, 150, 6, 4327);
    			option0.__value = "iphone_se";
    			option0.value = option0.__value;
    			add_location(option0, file, 152, 7, 4422);
    			option1.__value = "iphone_xr";
    			option1.value = option1.__value;
    			add_location(option1, file, 153, 7, 4475);
    			option2.__value = "iphone_12_pro";
    			option2.value = option2.__value;
    			add_location(option2, file, 154, 7, 4528);
