var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 11, 2, 194);
    			...
    			add_location(div1, file$1, 12, 2, 316);
    			...
    			add_location(div2, file$1, 13, 2, 446);
    			...
    			add_location(div3, file$1, 14, 2, 573);
    			attr_dev(div4, "class", "tabs svelte-1thg375");
    			add_location(div4, file$1, 10, 1, 172);
    			attr_dev(main, "class", "svelte-1thg375");
    			add_location(main, file$1, 9, 0, 163);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ currentTab, tabClick });
