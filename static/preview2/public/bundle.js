var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div3 = element("div");
    			div3.textContent = "📡";
    			attr_dev(div0, "class", "tab active svelte-s4z5ey");
    			attr_dev(div0, "data-name", "tools");
    			attr_dev(div0, "title", "Tools");
    			add_location(div0, file$1, 11, 8, 207);
    			attr_dev(div1, "class", "tab svelte-s4z5ey");
    			attr_dev(div1, "data-name", "capturer");
    			attr_dev(div1, "title", "Capturer");
    			add_location(div1, file$1, 12, 8, 302);
    			attr_dev(div2, "class", "tab svelte-s4z5ey");
    			attr_dev(div2, "data-name", "builder");
    			attr_dev(div2, "title", "Builder");
    			add_location(div2, file$1, 13, 8, 395);
    			attr_dev(div3, "class", "tab svelte-s4z5ey");
    			attr_dev(div3, "data-name", "events");
    			attr_dev(div3, "title", "Events & messages");
    			add_location(div3, file$1, 14, 8, 486);
    			attr_dev(div4, "class", "tabs svelte-s4z5ey");
    			add_location(div4, file$1, 10, 4, 179);
    			attr_dev(main, "class", "svelte-s4z5ey");
    			add_location(main, file$1, 9, 0, 167);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(div0, "click", tabClick, false, false, false),
    					listen_dev(div1, "click", tabClick, false, false, false),
    					listen_dev(div2, "click", tabClick, false, false, false),
    					listen_dev(div3, "click", tabClick, false, false, false)
    				];
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<Tabs> was created with unknown prop '${key}'`);
    	});

    	$$self.$capture_state = () => ({ tabClick });
    	return [];
    }
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 103, 2, 2788);
    			...
    			add_location(iframe, file, 109, 5, 2945);
    			...
    			add_location(div2, file, 107, 3, 2855);
    			add_location(p0, file, 115, 6, 3163);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "size", "45");
    			set_style(input0, "width", "200px");
    			add_location(input0, file, 116, 6, 3188);
    			attr_dev(input1, "type", "button");
    			input1.value = "↻";
    			attr_dev(input1, "class", "svelte-x8ul0v");
    			add_location(input1, file, 117, 6, 3302);
    			attr_dev(div3, "class", "widget");
    			add_location(div3, file, 114, 5, 3135);
    			add_location(p1, file, 120, 6, 3404);
    			attr_dev(input2, "type", "number");
    			attr_dev(input2, "size", "45");
    			attr_dev(input2, "min", "0");
    			attr_dev(input2, "class", "svelte-x8ul0v");
    			add_location(input2, file, 121, 6, 3424);
    			attr_dev(div4, "class", "widget");
    			add_location(div4, file, 119, 5, 3376);
    			add_location(p2, file, 124, 6, 3566);
    			attr_dev(input3, "type", "number");
    			attr_dev(input3, "size", "45");
    			attr_dev(input3, "min", "0");
    			attr_dev(input3, "class", "svelte-x8ul0v");
    			add_location(input3, file, 125, 6, 3587);
    			attr_dev(div5, "class", "widget");
    			add_location(div5, file, 123, 5, 3538);
    			add_location(p3, file, 128, 6, 3730);
    			option0.__value = "iphone_se";
    			option0.value = option0.__value;
    			add_location(option0, file, 130, 7, 3825);
    			option1.__value = "iphone_xr";
    			option1.value = option1.__value;
    			add_location(option1, file, 131, 7, 3878);
    			option2.__value = "iphone_12_pro";
    			option2.value = option2.__value;
    			add_location(option2, file, 132, 7, 3931);
